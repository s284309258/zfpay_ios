...
@implementation ApplyEPosVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self setNavBarTitle:@"EPOS"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (![StringUtil isEmpty:vcString]) {
        ...
        }else if([vcString isEqualToString:@"lcwl://PosInputInquiryVC"]){
            [MXRouter openURL:vcString parameters:@{@"type":@"epos"}];
            return;
        }
        /*
