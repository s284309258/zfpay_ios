...
@implementation MerchantManagerVC
...
-(YNPageScrollMenuView*)menu{
    if(!_menu){
        ...
        _menu = [YNPageScrollMenuView pagescrollMenuViewWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 38) titles: @[@"传统POS商户",@"MPOS商户",@"EPOS商户"]  configration:configration delegate:self currentIndex:0];
    }
    return _menu;
}
...
-(void)initUI{
    ...
    [self setNavBarTitle:@"我的商户"];
    CTMerchantVC* vc1 = [[CTMerchantVC alloc]init];
    vc1.type = @"CTPOS";
    MMerchantVC* vc2 = [[MMerchantVC alloc]init];
    CTMerchantVC* vc3 = [[CTMerchantVC alloc]init];
    vc3.type = @"EPOS";
