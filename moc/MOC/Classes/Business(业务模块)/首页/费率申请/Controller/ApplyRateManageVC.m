...
#import "ApplyRateManageVC.h"
#import "YNPageScrollMenuView.h"
#import "YNPageConfigration.h"
#import "ApplyRateCTVC.h"
#import "ApplyRateMVC.h"
@interface ApplyRateManageVC ()<YNPageScrollMenuViewDelegate>
...
@implementation ApplyRateManageVC
...
-(void)initUI{
    ...
    [self setNavBarTitle:@"费率申请"];
    [self setNavBarRightBtnWithTitle:@"申请记录" andImageName:nil];
    ApplyRateCTVC* vc1 = [[ApplyRateCTVC alloc]init];
    vc1.type = @"CTPOS";
    ApplyRateMVC* vc2 = [[ApplyRateMVC alloc]init];
    ApplyRateCTVC* vc3 = [[ApplyRateCTVC alloc]init];
    vc3.type = @"EPOS";
...
-(void)navBarRightBtnAction:(id)sender{
    [MXRouter openURL:@"lcwl://ApplyRateRecordVC"];
}
@end
