...
#define kWBCellTopPadding 12       // cell 内边距
#define kWBCellLeftPadding 15       // cell 内边距
#define kWBCellPadding 56//12       // cell 内边距
#define kWBCellRightPadding 15       //
#define kWBCellPaddingText 10   // cell 文本与其他元素间留白
#define kWBCellPaddingPic 2     // cell 多张图片中间留白
#define kWBCellProfileHeight 56 // cell 名片高度
#define kWBCellCardHeight 70    // cell card 视图高度
#define kWBCellNamePaddingLeft 4.5 // cell 名字和 avatar 之间留白
//#define kWBCellContentWidth (kScreenWidth - 2 * kWBCellPadding) // cell 内容宽度
#define kWBCellContentWidth (kScreenWidth - kWBCellRightPadding - kWBCellPadding) // cell 内容宽度
#define kWBCellNameWidth (kScreenWidth - 110) // cell 名字最宽限制

#define kWBCellImageWidth kScreenWidth // cell 图片宽度
#define kWBCellImageMaxHeight kScreenWidth // cell 图片最大高度

#define kWBCellTagPadding 8         // tag 上下留白
#define kWBCellTagNormalHeight 16   // 一般 tag 高度
#define kWBCellTagPlaceHeight 24    // 地理位置 tag 高度

#define kWBCellToolbarHeight 44     // cell 下方工具栏高度
#define kWBCellToolbarBottomMargin 10 // Toolbar 下方灰色留白
#define kWBCellMargin 5 // cell 下方灰色留白
...
// 颜色
#define kWBCellNameNormalColor UIColorHex(253FD8) //UIColorHex(333333) // 名字颜色
...
#define kWBCellTextHighlightColor [UIColor moBlue] // Link 文本色
...
#define kWBCellBackgroundColor UIColorHex(F4F5F4)    // Cell背景灰色
#define kWBCellHighlightColor UIColorHex(f0f0f0)     // Cell高亮时灰色
#define kWBCellInnerViewColor UIColorHex(F8F9F8)   // Cell内部卡片灰色
...
@property (nonatomic, strong) YYTextLayout *addressTextLayout; // 地址
...
//评论
@property (nonatomic, strong) YYTextLayout *commentTextLayout; //评论、点赞、转发文本
...
@property (nonatomic, strong) YYTextLayout *toolbarAwardTextLayout;
...
@property (nonatomic, assign) CGFloat toolbarAwardTextWidth;
