...
@property (nonatomic, strong) WBUser *transUser;
...
@property (nonatomic, strong) NSString *comments; ///评论部分，也包括点赞、转载的内容

//
@property (nonatomic, strong) NSString *circle_id;
@property (nonatomic, strong) NSString *circle_link;
@property (nonatomic, strong) NSString *circle_image_type;
@property (nonatomic, strong) NSString *circle_send_type; //00:自发。01:转发
@property (nonatomic, assign, readonly) BOOL isTransfer; //是否是转发
@property (nonatomic, assign, readonly) NSInteger circleFileType; ///文件类型，0:静态图片 1:动态图片 2:视频
@property (nonatomic, assign, readonly) CGSize circleFileSize; ///图片或者视频的尺寸
@property (nonatomic, strong, readonly) NSString *circleFileSufix; ///文件后缀，jpg、png、mp4等
@property (nonatomic, strong) NSString *circle_user_addr; //地址
@property (nonatomic, strong) NSMutableArray<WBCommentItem *> *comment_info_list;
@property (nonatomic, strong) NSMutableArray<PraiseItem *> *praise_info_list;

//转发相关
@property (nonatomic, strong) NSString *trans_link;
@property (nonatomic, strong) NSString *trans_user_name;
@property (nonatomic, strong) NSString *trans_user_id;
@property (nonatomic, strong) NSString *trans_user_remark;
@property (nonatomic, strong) NSString *trans_message_type;
@property (nonatomic, strong) NSString *trans_image_type;
@property (nonatomic, strong) NSString *trans_content;
@property (nonatomic, strong) NSString *trans_user_head_photo;
@property (nonatomic, strong) NSString *trans_image_size;

@end

@interface WBCommentItem : NSObject
@property (nonatomic, copy)   NSString *content;
@property (nonatomic, copy)   NSString *comment_id;
@property (nonatomic, copy)   NSString *_id;
@property (nonatomic, copy)   NSString *user_head_photo;
@property (nonatomic, strong) NSString *comment_user_head_photo;
...
@property (nonatomic, strong) NSString *token_user;
@end

@interface PraiseItem : NSObject
