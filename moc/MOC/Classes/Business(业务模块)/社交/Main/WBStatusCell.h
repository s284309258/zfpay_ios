...
{
    ToolbarTypeList = 0,//列表风格
    ToolbarTypeDetail = 1,//详情风格
};
...
//@property (nonatomic, strong) SJPlayView *sjPlayView; //视频控件
@property (nonatomic, weak) WBStatusCell *cell;
@end
...
//评论部分
@interface WBStatusCommentView : UIView
...
@property (nonatomic, strong) WBStatusCommentView *commentView; //评论
...
@property (nonatomic, strong) UIButton *rankButton;             // 帖子排行图标
