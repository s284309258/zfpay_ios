...
@interface CTWDEJVC ()<UITableViewDelegate,UITableViewDataSource,PGDatePickerDelegate>
...
-(void)getDayAgencyTraditionalPosDetail{
    [self getDayMerchantTraditionalPosDetail:@{@"date":[self.dayStr stringByReplacingOccurrencesOfString:@"-" withString:@""]} completion:^(id object, NSString *error) {
        if (object) {
            self.dayData = object;
...
-(void)getMonthAgencyTraditionalPosDetail{
    [self getMonthMerchantTraditionalPosDetail:@{@"date":[self.monthStr stringByReplacingOccurrencesOfString:@"-" withString:@""]} completion:^(id object, NSString *error) {
        if (object) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    view.chartBlock  = ^(id data) {
        if (indexPath.section == 0) {
            [MXRouter openURL:@"lcwl://PerformanceChartVC" parameters:@{@"type":@"CTWD",@"subType":@"month",@"dateStr":[self.monthStr stringByReplacingOccurrencesOfString:@"-" withString:@""]}];
        }else{
            [MXRouter openURL:@"lcwl://PerformanceChartVC" parameters:@{@"type":@"CTWD",@"subType":@"day",@"dateStr":[self.dayStr stringByReplacingOccurrencesOfString:@"-" withString:@""]}];
        }
    };
