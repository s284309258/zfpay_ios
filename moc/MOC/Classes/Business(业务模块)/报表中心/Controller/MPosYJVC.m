...
#import "MDLYJVC.h"
#import "MWDEJVC.h"
@interface MPosYJVC ()<YNPageScrollMenuViewDelegate>
...
-(void)initUI{
    ...
    [self setNavBarTitle:@"MPOS"];
    MDLYJVC* vc1 = [[MDLYJVC alloc]init];
    MWDEJVC* vc2 = [[MWDEJVC alloc]init];
