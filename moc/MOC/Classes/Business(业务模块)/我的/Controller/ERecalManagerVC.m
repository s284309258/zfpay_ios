...
@interface ERecalManagerVC ()<YNPageScrollMenuViewDelegate>
...
@implementation ERecalManagerVC
...
-(void)initUI{
    ERecallingVC*   vc1 = [[ERecallingVC alloc]init];
    ERecaledVC*    vc2 = [[ERecaledVC alloc]init];
    ERecallRefuseVC*  vc3 = [[ERecallRefuseVC alloc]init];
