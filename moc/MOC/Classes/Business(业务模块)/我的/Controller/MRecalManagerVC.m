...
@interface MRecalManagerVC ()<YNPageScrollMenuViewDelegate>
...
@implementation MRecalManagerVC
...
-(void)initUI{
    MRecallingVC*   vc1 = [[MRecallingVC alloc]init];
    MRecaledVC*    vc2 = [[MRecaledVC alloc]init];
    MRecallRefuseVC*  vc3 = [[MRecallRefuseVC alloc]init];
