...
#import "CTRecallRefuseVC.h"
#import "TextTextTextView.h"
#import "NSObject+Home.h"
#import "ScanTraditionalPosModel.h"
@interface CTRecallRefuseVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation CTRecallRefuseVC
...
//}
-(void)initData{
    [self getRecallTraditionalPosList:@{@"status":@"08"} completion:^(id array, NSString *error) {
        if (array) {
