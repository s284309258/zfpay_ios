...
#import "ERecallRefuseVC.h"
#import "TextTextTextView.h"
#import "NSObject+Home.h"
#import "ScanTraditionalPosModel.h"
@interface ERecallRefuseVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ERecallRefuseVC
...
//}
-(void)initData{
    [self getRecallTraditionalPosList:@{@"status":@"08",@"pos_type":@"epos"} completion:^(id array, NSString *error) {
        if (array) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [view reloadTop: [NSString stringWithFormat:@"SN码:%@",model.sn] bottom:model.cre_datetime right:@"已拒绝"];
    return cell;
}
//
