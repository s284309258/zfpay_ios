...
#import "MRecallRefuseVC.h"
#import "TextTextTextView.h"
#import "NSObject+Home.h"
#import "ScanTraditionalPosModel.h"
@interface MRecallRefuseVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MRecallRefuseVC
...
//}
-(void)initData{
    [self getRecallMposList:@{@"status":@"08"} completion:^(id array, NSString *error) {
        if (array) {
