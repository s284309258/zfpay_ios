...
#import "CTRecaledVC.h"
#import "CTRecallRefuseVC.h"
@interface CTRecalManagerVC ()<YNPageScrollMenuViewDelegate>
...
@implementation CTRecalManagerVC
...
-(void)initUI{
    CTRecallingVC*   vc1 = [[CTRecallingVC alloc]init];
    CTRecaledVC*    vc2 = [[CTRecaledVC alloc]init];
    CTRecallRefuseVC*  vc3 = [[CTRecallRefuseVC alloc]init];
