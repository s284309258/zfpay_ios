...
@interface LLKRecaledVC ()


@end

@implementation LLKRecaledVC
...
-(void)initData{
    [self getRecallTrafficCardList:@{@"status":@"09"} completion:^(id array, NSString *error) {
        if (array) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [view reloadTop: [NSString stringWithFormat:@"SN码:%@",model.card_no] bottom:model.cre_datetime right:@"已同意"];
    return cell;
}
