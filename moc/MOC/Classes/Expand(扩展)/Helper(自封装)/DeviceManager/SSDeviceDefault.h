...
#define StatuBarHeight  [SSDeviceDefault shareCKDeviceDefault].statuBarHeight
#define NavBarHeight  [SSDeviceDefault shareCKDeviceDefault].navBarHeight
#define SafeAreaBottomHeight  [SSDeviceDefault shareCKDeviceDefault].safeAreaBottomHeight
