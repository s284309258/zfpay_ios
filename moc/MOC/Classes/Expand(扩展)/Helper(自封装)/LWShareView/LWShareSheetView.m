...
+ (NSArray *)topMenus
{
    return @[@{kShareIcon:@"微信",kShareTitle:@"微信"},@{kShareIcon:@"朋友圈",kShareTitle:@"微信朋友圈"}];//,@{kShareIcon:@"share_qq",kShareTitle:@"抖音"} @[@{kShareIcon:@"share_artbox",kShareTitle:@"转发"},@{kShareIcon:@"share_artchat",kShareTitle:@"艺信好友"}];
}
