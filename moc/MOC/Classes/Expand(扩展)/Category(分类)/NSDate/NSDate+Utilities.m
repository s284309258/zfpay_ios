...
+ (NSString *)dateRankForDay:(NSInteger)rankDay {
    NSDate *today = [[NSDate date] transCurTimeZoneDate];
    NSDate *lastDay = [today dateByAddingDays:rankDay];
    NSString *rankString = [NSString stringWithFormat:@"%@~%@",[[[today description] componentsSeparatedByString:@" "] firstObject],[[[lastDay description] componentsSeparatedByString:@" "] firstObject]];
    return rankString;
}
...
- (NSInteger)distanceSecondToDate:(NSDate *)anotherDate
{
    NSCalendar *gregorianCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    NSDateComponents *components = [gregorianCalendar components:NSCalendarUnitDay fromDate:self toDate:anotherDate options:0];
