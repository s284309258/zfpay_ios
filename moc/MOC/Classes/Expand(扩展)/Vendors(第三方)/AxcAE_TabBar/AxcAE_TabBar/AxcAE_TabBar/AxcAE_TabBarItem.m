...
//        self.titleLabel.strokeColor = [UIColor colorWithHexString:@"#AC6F18"];
//        self.titleLabel.strokeSize = 2;
...
//        self.titleLabel.strokeColor = nil;
//        self.titleLabel.strokeSize = 0;
...
- (void)setTitleLabel:(THLabel *)titleLabel{
