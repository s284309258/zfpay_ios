...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat x = 0;
    if(self.textNumLabelAligment == TextNumLabelAligmentLeft) {
        x = 10;
    } else if(self.textNumLabelAligment == TextNumLabelAligmentRight) {
        x = size.width - 110;
    }
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.textNumLabel attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeft multiplier:1 constant:x]];
...
- (void)setTextNumLabelAligment:(TextNumLabelAligment)textNumLabelAligment {
    _textNumLabelAligment = textNumLabelAligment;
    self.textNumLabel.textAlignment = textNumLabelAligment;
}
